...
MYSQL_ROOT_PASSWORD='11mja2018';
MYSQL_WEB_USER='jahid';
MYSQL_WEB_PASSWORD='11mja2018'
MYSQL_PORT=3306;
MYSQL_DB_SUFFIX='wp_';
...
SOURCE_DIR="/var/www/acadia/public_html/corporate/usync"
BACKUP_DIR_MAIN="/var/www/acadia/public_html/corporate/usync/SYNC_BACKUP"
SYNC_DIR_PREFIX=SYNC

#Document root for Zipping 
DOCUMENT_ROOT_MAIN=/var/www/acadia/public_html/corporate
...
UNWANTED_STRING='//stagingacadia.hww'
WANTED_STRING='//liveacadia.hww'
PHP_DB_TEXT_REPLACE_SCRIPT='string_to_replace_db.php'
delimiter=':'

SYNC_SOURCE="http://stagingacadia.hww"
SYNC_DESTINATION="http://liveacadia.hww"
