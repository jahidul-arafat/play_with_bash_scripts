...
dnf -q -y install openssl httpd httpd-devel file git-core gcc jpegoptim optipng zlib-devel gcc make expat-devel pcre-devel htop
...
mv /var/lib/mysql/ca-key.predisem /var/lib/mysql/ca-key.pem.back
